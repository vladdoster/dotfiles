...
module.init = function()
    inspect, reload = hs.inspect, reloadHS
    ...
    dumpScreens = function()
        hs.fnutils.each(hs.screen.allScreens(), function(s) print(s:id(), s:position(), s:frame(), s:name()) end)
    end
    ...
    hs.console.toolbar(nil) -- no toolbar
end
return module
