...
local isResizable = function(win) return axuiWindowElement(win):isAttributeSettable('AXSize') end
module.init = function()
    ...
    hs.grid.set = function(win, cell, screen)
        ...
        if cell.h < screenGrid.h and cell.h % 1 == 0 then
            ...
            if cell.y + cell.h ~= screenGrid.h then frame.h = frame.h + margins.h / 2 end
        end
