...
module.toggleGrid = function()
    if cache.canvases ~= nil and #cache.canvases > 0 then
        hs.timer.doAfter(0.5, function() cache.canvases = {} end)
        return
    end
    hs.fnutils.each(hs.screen.allScreens(), function(screen)
        ...
        if hhtwm then
            ...
            frame.y, frame.h = frame.y + screenMarinFromTiling, frame.h - screenMarinFromTiling
        end
        ...
        if cache.canvases == nil then cache.canvases = {} end
