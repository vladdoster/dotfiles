local cache = {
    borderDrawings = {},
    borderDrawingFadeOuts = {}
}
local module = { cache = cache }

-- returns 'graphite' or 'aqua'
local getOSXAppearance =
    function()
        local _, res =
...
module.getHighlightWindowColor =
    function()
        local blueColor = {
            red = 50 / 255,
            green = 138 / 255,
