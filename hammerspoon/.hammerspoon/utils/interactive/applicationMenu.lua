...
-- Are empty directories pruned from the menu items?
-- appMenu:pruneEmptyDirs(true)

-- Key modifiers which cause the drop-down menu to display a control menu.  Set to the
-- empty table to disable the control menu completely.
-- appMenu:controlMenuMods({ ctrl = true })
...
-- menu object in case you want to manipulate it later.
