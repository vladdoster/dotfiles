...
local timeStringToNumber = function(
    dateStr)
...
local numberToDuration =
    function(num)
        local hours =
            math.floor(num / 60)
        local minutes =
            math.floor(num - hours * 60)
    ...
    function()
        hs.task.new(
            ...
            function(_, stdOut)
                ...
                local startTimeMinutes =
                    timeStringToNumber(
                        startTime)
                local endTimeMinutes =
                    timeStringToNumber(
                        endTime)
                local currentTimeMinutes =
                    timeStringToNumber(
                        currentTime)

                if currentTimeMinutes
                    >= startTimeMinutes then
                    local 
                        timeLeftMinutes =
                        endTimeMinutes
                            - currentTimeMinutes
